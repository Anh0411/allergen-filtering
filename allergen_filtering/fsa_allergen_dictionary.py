    ...
    def _initialize_allergens(self) -> Dict[str, AllergenCategory]:
        ...
        return {
            "celery": AllergenCategory(
                ...
                scientific_names=["apium graveolens", "celery protein isolate", "celery protein concentrate"],
                hidden_sources=[
            ...
            "gluten": AllergenCategory(
                ...
                synonyms=[
                    "wheat gluten", "rye gluten", "barley gluten", "spelt", "kamut", "triticale", "einkorn", "emmer",
                    "wheat flour", "rye flour", "barley flour", "oat flour", "wheat protein", "rye protein",
                    "barley protein", "oat protein", "wheat starch", "rye starch", "barley starch", "oat starch",
                    "wheat bran", "rye bran", "barley bran", "oat bran", "wheat germ", "rye germ", "barley germ",
                    "oat germ", "wheat semolina", "rye semolina", "barley semolina", "oat semolina", "wheat durum",
                    "rye durum", "barley durum", "oat durum", "wheat bread", "rye bread", "barley bread", "oat bread",
                    "wheat pasta", "rye pasta", "barley pasta", "oat pasta", "wheat noodles", "rye noodles",
                    "barley noodles", "oat noodles", "wheat cereal", "rye cereal", "barley cereal", "oat cereal",
                    "wheat flakes", "rye flakes", "barley flakes", "oat flakes", "wheat crackers", "rye crackers",
                    "barley crackers", "oat crackers", "wheat protein isolate", "rye protein isolate",
                    ...
                    "barley protein derivative", "oat protein derivative", "all purpose flour", "bread flour", "cake flour",
                    "cereal extract", "club wheat", "common wheat", "durum wheat", "farina", "graham flour",
                    "high gluten flour", "high protein flour", "whole wheat flour", "whole wheat bread", "whole rye flour",
                    "whole rye bread", "whole barley flour", "whole barley bread", "whole oat flour", "whole oat bread"
                ],
                scientific_names=[
                ...
                hidden_sources=[
                    "flour", "pasta", "seitan", "semolina", "vital wheat gluten", "all purpose flour", "bread flour",
                    "cake flour", "cereal extract", "club wheat", "common wheat", "durum wheat", "einkorn", "emmer",
                    "farina", "graham flour", "high gluten flour", "high protein flour", "kamut", "triticale",
                    "wheat bran", "wheat flour", "wheat germ", "wheat gluten", "wheat meal", "wheat protein",
                    "wheat protein concentrate", "wheat protein isolate", "wheat starch", "whole wheat flour",
                    "whole wheat bread", "rye bran", "rye flour", "rye germ", "rye gluten", "rye meal", "rye protein",
                    "rye protein concentrate", "rye protein isolate", "rye starch", "whole rye flour", "whole rye bread",
                    "barley bran", "barley flour", "barley germ", "barley gluten", "barley meal", "barley protein",
                    "barley protein concentrate", "barley protein isolate", "barley starch", "whole barley flour",
                    "whole barley bread", "oat bran", "oat flour", "oat germ", "oat gluten", "oat meal", "oat protein",
                    "oat protein concentrate", "oat protein isolate", "oat starch", "whole oat flour", "whole oat bread"
                ],
            ...
            "crustaceans": AllergenCategory(
                name="Crustaceans",
                main_ingredients=["shrimp", "prawn", "crab", "lobster", "crayfish", "crawfish", "krill"],
                synonyms=[
            ...
            "egg": AllergenCategory(
                ...
                synonyms=[
                    "albumin", "albumen", "egg albumin", "egg white protein", "egg protein",
                    "egg solids", "egg powder", "dried egg", "egg substitute", "egg replacer",
                    "egg white powder", "egg yolk powder", "egg protein isolate", "egg protein concentrate",
                    "egg protein hydrolysate", "egg protein derivative", "apovitellenin", "avidin",
                    "egg globulin", "globulin", "livetin", "ovomucin", "ovovitellin", "silici albuminate",
                    "simplesse", "surimi", "vitellin"
                ],
                scientific_names=[
            ...
            "fish": AllergenCategory(
                ...
                synonyms=[
                    ...
                    "swordfish", "tilapia", "trout", "tuna", "whitefish", "bouillabaisse",
            ...
            "lupin": AllergenCategory(
                ...
                synonyms=[
                    "lupine", "lupini", "lupin protein", "lupin protein isolate", "lupin protein concentrate",
                    "lupin protein hydrolysate", "lupin oil", "lupin extract", "lupin powder", "lupin meal",
                    "lupin paste", "lupin butter", "lupin milk", "lupin yogurt", "lupin cheese", "lupin bread",
            ...
            "milk": AllergenCategory(
                ...
                synonyms=[
                    "casein", "caseinate", "lactose", "lactalbumin", "whey", "whey protein",
                    "milk protein", "milk solids", "milk powder", "skim milk", "whole milk", "buttermilk",
                    "evaporated milk", "condensed milk", "milk fat", "milk sugar", "galactose", "curd", "rennet",
                    "ghee", "clarified butter", "milk derivative", "milk byproduct", "alpha-lactalbumin",
                    "lactoglobulin", "milk protein concentrate", "milk protein isolate", "artificial butter flavor",
                    "butter flavor", "caramel color", "chocolate", "high protein flour", "lactic acid starter culture",
                    "margarine", "natural flavoring", "non-dairy creamer", "nougat", "pudding", "simplesse",
            ...
            "molluscs": AllergenCategory(
                name="Molluscs",
                main_ingredients=[
                    "clam", "mussel", "mussels", "oyster", "oysters", "scallop", "scallops", "abalone", "cockle", "conch", "limpet", "periwinkle", "sea urchin", "whelk", "snail"
                ],
                synonyms=[
                ...
                scientific_names=[
                    ...
                    "mollusk gelatin", "mollusk oil", "mollusk oil"
                ],
                hidden_sources=[
                    "abalone", "cockle", "conch", "limpet", "mussel", "mussels", "oyster", "oysters", "periwinkle", "scallop", "scallops", "sea urchin", "snail", "whelk",
                    "mollusc protein", "mollusk protein", "clam protein", "mussel protein", "oyster protein", "scallop protein",
                    "abalone protein", "cockle protein", "conch protein", "limpet protein", "periwinkle protein", "sea urchin protein",
                    "whelk protein", "snail protein", "mollusc oil", "mollusk oil", "clam oil", "mussel oil", "oyster oil", "scallop oil",
                    "abalone oil", "cockle oil", "conch oil", "limpet oil", "periwinkle oil", "sea urchin oil", "whelk oil", "snail oil",
            ...
            "peanuts": AllergenCategory(
                ...
                synonyms=[
                    ...
                    "artificial nuts", "beer nuts", "goober nuts", "goober peas", "lupin", "mandelonas",
                    "mixed nuts", "nut meat", "nut pieces"
                ],
                scientific_names=[
            ...
            "sesame": AllergenCategory(
                ...
                synonyms=[
                    ...
                    "sesame powder", "sesame salt", "gomasio", "benne", "benne seed", "benne seeds", "halvah"
                ],
                scientific_names=[
                ...
                hidden_sources=[
                    "benne", "benne seed", "benne seeds", "gomasio", "halvah", "sesame flour", "sesame oil",
            ...
            "soy": AllergenCategory(
                ...
                synonyms=[
                    ...
                    "hydrolyzed soy protein", "mono-diglyceride", "monosodium glutamate", "msg",
                    "natural flavoring", "soy albumin", "soybean oil", "soybean paste", "soybean protein",
                    "soybean protein concentrate", "soybean protein hydrolysate", "soybean protein isolate"
                ],
                scientific_names=[
            ...
            "tree_nuts": AllergenCategory(
                ...
                synonyms=[
                    ...
                    "chestnut", "chinquapin", "coconut", "ginkgo nut", "hickory nut", "litchi nut",
                    "lychee nut", "macadamia nut", "marzipan", "nangai nut", "natural nut extract",
                    "nut butters", "nut meat", "pesto", "shea nut", "tree nut protein concentrate",
                    "tree nut protein isolate"
                ],
                scientific_names=[
                ...
                hidden_sources=[
                    ...
                    "nut meat", "nut oil", "nut paste", "pecan", "pesto", "pignoli",
